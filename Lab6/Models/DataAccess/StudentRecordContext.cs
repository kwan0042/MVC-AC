...
namespace Lab6.Models.DataAccess
{
    public partial class StudentRecordContext : DbContext
    {
        ...
        public virtual DbSet<EmployeeRole> EmployeeRole { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AcademicRecord>(entity =>
            {
                entity.HasKey(e => new { e.StudentId, e.CourseCode })
                    .HasName("PK__Academic__3D052599BED035BC");
            ...
            modelBuilder.Entity<Course>(entity =>
            {
                entity.HasKey(e => e.Code)
                    .HasName("PK__Course__A25C5AA61BFE187F");
                ...
                entity.HasMany(d => d.StudentStudentNums)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("CourseCourseId", "StudentStudentNum").HasName("PK__Registra__92ECCCE944A6F12D");
